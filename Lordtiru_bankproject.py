print("_____"*20)
customerNames = ['Human','Ironman', 'Hulk', 'SpiderMan', 'Venom', 'Thor']
customerPins = ['1111', '2222', '3333', '4444', '5555','6666']
customerBalances = [200000, 70000, 80000, 90000, 100000, 55555]
deposition = 0
withdrawal = 0
balance = 0
counter_1 = 1
...
while True:
    ...
    print("_____"*20)
    print("\n")
    print(" >>>>------->  Welcome to --LordTiru-- Bank  <-------<<<<       ")
    print("_____"*20)
    print("_____"*20)
    ...
    if choiceNumber == "1":
        ...
        print("Thanks for using ---LordTiru--- banking system!")
        print("\n")
        print("Visit again")
